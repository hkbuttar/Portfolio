...
.
├── data/
│   ├── projects/            # one YAML file per project (25 currently)
...
# → creates data/projects/26-my-new-project.yaml with placeholder fields
```
...
- **Projects** (`projects.html` + `projects/*.html`) — 25 entries
...
- ✅ 24 of 25 projects have real GitHub repo links; 8 projects + 1
