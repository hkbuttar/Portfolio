...
.
├── data/
│   ├── projects/            # one YAML file per project (28 currently)
...
# → creates data/projects/29-my-new-project.yaml with placeholder fields
```
...
- **Projects** (`projects.html` + `projects/*.html`) — 28 entries
