...
.
├── data/
│   ├── projects/            # one YAML file per project (16 currently)
...
# → creates data/projects/17-my-new-project.yaml with placeholder fields
```
...
- **Projects** (`projects.html` + `projects/*.html`) — 16 entries
...
- ✅ 15 of 16 projects have real GitHub repo links; 8 projects + 1
