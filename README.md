...
.
├── data/
│   ├── projects/            # one YAML file per project (21 currently)
...
# → creates data/projects/22-my-new-project.yaml with placeholder fields
```
...
- **Projects** (`projects.html` + `projects/*.html`) — 21 entries
...
- ✅ 20 of 21 projects have real GitHub repo links; 8 projects + 1
