...
.
├── data/
│   ├── projects/            # one YAML file per project (17 currently)
...
# → creates data/projects/18-my-new-project.yaml with placeholder fields
```
...
- **Projects** (`projects.html` + `projects/*.html`) — 17 entries
...
- ✅ 16 of 17 projects have real GitHub repo links; 8 projects + 1
