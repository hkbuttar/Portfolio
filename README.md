...
.
├── data/
│   ├── projects/            # one YAML file per project (15 currently)
...
# → creates data/projects/16-my-new-project.yaml with placeholder fields
```
...
- **Projects** (`projects.html` + `projects/*.html`) — 15 entries
...
- ✅ 14 of 15 projects have real GitHub repo links; 8 projects + 1
