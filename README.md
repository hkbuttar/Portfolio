...
.
├── data/
│   ├── projects/            # one YAML file per project (26 currently)
...
# → creates data/projects/27-my-new-project.yaml with placeholder fields
```
...
- **Projects** (`projects.html` + `projects/*.html`) — 26 entries
...
- ✅ 25 of 26 projects have real GitHub repo links; 8 projects + 1
