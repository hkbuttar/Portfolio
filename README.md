...
.
├── data/
│   ├── projects/            # one YAML file per project (12 currently)
...
# → creates data/projects/13-my-new-project.yaml with placeholder fields
```
...
- **Projects** (`projects.html` + `projects/*.html`) — 12 entries
...
- ✅ 11 of 12 projects have real GitHub repo links; 8 projects + 1
