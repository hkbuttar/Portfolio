...
.
├── data/
│   ├── projects/            # one YAML file per project (18 currently)
...
# → creates data/projects/19-my-new-project.yaml with placeholder fields
```
...
- **Projects** (`projects.html` + `projects/*.html`) — 18 entries
...
- ✅ 17 of 18 projects have real GitHub repo links; 8 projects + 1
