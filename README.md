...
.
├── data/
│   ├── projects/            # one YAML file per project (27 currently)
...
# → creates data/projects/28-my-new-project.yaml with placeholder fields
```
...
- **Projects** (`projects.html` + `projects/*.html`) — 27 entries
...
- ✅ 26 of 27 projects have real GitHub repo links; 8 projects + 1
