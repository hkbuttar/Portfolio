...
.
├── data/
│   ├── projects/            # one YAML file per project (13 currently)
...
# → creates data/projects/14-my-new-project.yaml with placeholder fields
```
...
- **Projects** (`projects.html` + `projects/*.html`) — 13 entries
...
- ✅ 12 of 13 projects have real GitHub repo links; 8 projects + 1
