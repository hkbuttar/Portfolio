...
.
├── data/
│   ├── projects/            # one YAML file per project (29 currently)
...
# → creates data/projects/30-my-new-project.yaml with placeholder fields
```
...
- **Projects** (`projects.html` + `projects/*.html`) — 29 entries
...
- ✅ 28 of 29 projects have real GitHub repo links; 9 projects + 1
