...
.
├── data/
│   ├── projects/            # one YAML file per project (14 currently)
...
# → creates data/projects/15-my-new-project.yaml with placeholder fields
```
...
- **Projects** (`projects.html` + `projects/*.html`) — 14 entries
...
- ✅ 13 of 14 projects have real GitHub repo links; 8 projects + 1
